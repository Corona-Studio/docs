                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            { text: "进入服务器", link: "/zhCN/CMFS/servers/SparkPixel/guidance" },
                            { text: "用户服务协议", link: "/zhCN/CMFS/servers/SparkPixel/eula" },
                            { text: "审核渠道和规范", link: "/zhCN/CMFS/servers/SparkPixel/rules" },
                            { text: "管理团队", link: "/zhCN/CMFS/servers/SparkPixel/team" },
                            { text: "违规处理办法", link: "/zhCN/CMFS/servers/SparkPixel/punishments" },
                            { text: "违规处理公告", link: "/zhCN/CMFS/servers/SparkPixel/banlist" },
                        ]
                    }
                ]
            },
